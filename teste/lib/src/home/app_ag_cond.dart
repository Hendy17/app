...
class AppAgCond extends StatelessWidget {
  const AppAgCond({Key? key}) : super(key: key);
            ...
            return GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.blue[100], // Alterada para azul
                  ...
                  boxShadow: [
                    BoxShadow(
                      ...
                      spreadRadius: 2,
                      blurRadius: 5,
                      offset: Offset(0, 3), // Altera a posição da sombra para dar o efeito 3D
                    ),
                  ],
                ),
                child: Center(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                // Aqui você pode implementar a lógica para mostrar a mensagem de horário indisponível
                Navigator.of(context).pop();
              },
              child: Text('Cancelar'),
            ),
